<?php
  ...
  // * Fichier: back.php
  // *
  // * Back-office permettant pour les étudiants :
  // * • d’avoir un écran listant l’ensemble des enregistrements mais sans toutes
  // *   les informations. Cet écran fourni les liens d’accès à la visualisation,
  // *   à la modification et à la suppression de l’étudiant sélectionné.
  // * • de créer un nouvel étudiant
  // * • de visualiser un étudiant
  // * • de modifier un étudiant
  // * • du supprimer un étudiant
  // ***************************************************************************
      ...
      echo '<table class="table">';
        ...
        for ($i=0; $tab_etudiant = $back->fetchObject('Etudiant');$i++)
        {
          ...
          echo '<tr>';
            ...
            echo '<td>';
              echo "<a href='details.php?mail=$mail_etudiant'>
                      <button type='button' class='btn btn-info'>
                        <span class='fa fa-search' aria-hidden='true'></span> Détails
                      </button>";
              echo "<a href='modifier.php?mail=$mail_etudiant&nom=$nom_etudiant&prenom=$prenom_etudiant&date_naissance=$date_etudiant&section=$section_etudiant'>
                      <button type='button' class='btn btn-warning'>
                        <span class='fa fa-edit' aria-hidden='true'></span> Modifier
                      </button>";
              echo "<a href='supprimer.php?mail=$mail_etudiant'>
                      <button type='button' class='btn btn-danger'>
                        <span class='fa fa-remove' aria-hidden='true'></span> Supprimer
                      </button>";
            echo '</td>';
          echo '</tr>'."\n";
        }
